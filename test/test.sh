...
AWS_PROFILE=${AWS_PROFILE} ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook test/teardown.yml --inventory-file=test/hosts-test --extra-vars "region=${AWS_REGION} ec2_key_name=${EC2_KEY_NAME}"
